...
class CustomLabels {
  ...
  static TextStyle h4 = GoogleFonts.poppins(fontSize: 16, height: 1, fontWeight: FontWeight.w600);
  ...
  static TextStyle tableUser = GoogleFonts.poppins(fontSize: 14, height: 1, fontWeight: FontWeight.w700, letterSpacing: 0);
  static TextStyle tableText = GoogleFonts.poppins(fontSize: 14, height: 1, fontWeight: FontWeight.w400);
